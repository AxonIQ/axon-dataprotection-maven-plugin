<!--
Thanks for taking the time to draft up an issue for Axon Data Protection Maven Plugin!
Prior to starting off, please read the following:

## Usage Questions

If you are having difficulty using Axon Data Protection Maven Plugin,
...
You can find all three of them [here](https://github.com/axon-dataprotection-maven-plugin/issues/new/choose). 
